...
aimd_path = 'B:/projects/03_3d_metad/03_300K/RUN12'
...
hills_path = 'HILLS_300K_60'
xdb.hillspot2hills(hillspot_path, hills_path, ['x', 'y', 'z'],
                   height_conversion=1, sigma_conversion=1, del_inter=True )

# read HILLSPOT into a pandas dataframe
import numpy as np

hills = np.loadtxt(hills_path, skiprows=1)
