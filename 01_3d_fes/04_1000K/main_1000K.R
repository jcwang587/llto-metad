...
hillsf <- read.hills3d("HILLS_1000K")
...
svg("1000K_XZ.svg", width=7, height=7)
print(lp_xz)
dev.off()
...
svg("1000K_XY.svg", width=7, height=7)
print(lp_xy)
dev.off()
...
svg("1000K_YZ.svg", width=7, height=7)
print(lp_yz)
dev.off()
...
ggsave("1000K_projected_z.png", plot=p, width=10, height=6)
