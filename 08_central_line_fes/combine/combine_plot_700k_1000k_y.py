...
# Load the data
fes_a_700k = np.load('../01_700k/min_y_700k.npy')
fes_a_700k = fes_a_700k - np.min(fes_a_700k)
fes_a_1000k = np.load('../02_1000k/min_y_1000k.npy')
...
ax1.legend(['1000K Path-7', '700K Path-7'],
           fontsize=16, loc='upper center', ncol=2)

plt.tight_layout()
plt.savefig('combine_plot_700k_1000k_y.tif', dpi=300)
plt.show()
