...
# export the data
np.save('../combine_plot/1000k_a_fes.npy', fes_x)
np.save('../combine_plot/1000k_c_fes.npy', fes_z)
np.save('../combine_plot/1000k_a.npy', x_norm)
np.save('../combine_plot/1000k_c.npy', z_norm)
