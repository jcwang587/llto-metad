...
# export the data
np.save('../combine_plot/700k_a_fes.npy', fes_x)
np.save('../combine_plot/700k_c_fes.npy', fes_z)
np.save('../combine_plot/700k_a.npy', x_norm)
np.save('../combine_plot/700k_c.npy', z_norm)
